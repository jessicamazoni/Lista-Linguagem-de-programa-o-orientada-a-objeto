package lista02;
public class Celular extends Telecomunicador{
    ...
    public Celular(String tiposConexao, String cor, float peso, float preco, float tamanhoTela, float resolucaoCamera, float resolucaoCameraFrontal, int bateria, int memoria) {
